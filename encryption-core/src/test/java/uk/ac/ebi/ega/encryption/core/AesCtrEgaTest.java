...
public class AesCtrEgaTest {
    ...
    @Test
    public void testCipEncryption() throws IOException, AlgorithmInitializationException {
    ...
    private byte[] doEncrypt(byte[] data, char[] password) throws IOException, AlgorithmInitializationException {
    ...
    @Test
    public void testCipDecryption() throws IOException, AlgorithmInitializationException {
