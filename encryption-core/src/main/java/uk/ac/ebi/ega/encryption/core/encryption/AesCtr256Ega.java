...
public class AesCtr256Ega extends JdkEncryptionAlgorithm {
    ...
    protected void initializeRead(InputStream inputStream, char[] password) throws AlgorithmInitializationException {
        ...
        try {
            ...
            throw new AlgorithmInitializationException("AesCtr256Ega could not read IV from input stream", e);
        }
    ...
    protected void initializeWrite(char[] password, OutputStream outputStream) throws AlgorithmInitializationException {
        ...
        try {
            ...
            throw new AlgorithmInitializationException("AesCtr256Ega could not write IV to output stream", e);
        }
