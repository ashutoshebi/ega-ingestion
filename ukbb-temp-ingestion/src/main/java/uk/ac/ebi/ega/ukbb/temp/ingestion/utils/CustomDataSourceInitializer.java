 ...
 */
package uk.ac.ebi.ega.ukbb.temp.ingestion.utils;
...
/**
 * Class copied from spring-boot autoconfigure as it is considered a package protected class, all attributions are as
 * follow.
 * <p>
...
class CustomDataSourceInitializer {
    ...
    private static final Log logger = LogFactory.getLog(CustomDataSourceInitializer.class);
     ...
     */
    CustomDataSourceInitializer(DataSource dataSource, DataSourceProperties properties,
