...
public class KafkaConfiguration {
    ...
    public Map producerConfigs() {
        ...
        properties.put(ProducerConfig.METADATA_MAX_AGE_CONFIG, 16384);
        return properties;
    }
    ...
    @Bean
    public ProducerFactory<String, NewFileEvent> producerFactory() {
        DefaultKafkaProducerFactory<String, NewFileEvent> factory =
    ...
    @Bean
    public KafkaTemplate<String, NewFileEvent> kafkaTemplate() {
