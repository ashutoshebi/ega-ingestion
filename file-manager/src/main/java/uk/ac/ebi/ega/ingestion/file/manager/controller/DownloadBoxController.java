...
public class DownloadBoxController {
    ...
    @ResponseBody
    public PersistentEntityResource postDownloadBox(@RequestBody DownloadBox downloadBox,
                                                    PersistentEntityResourceAssembler assembler) {
        downloadBox.persist();
        return assembler.toFullResource(repository.save(downloadBox));
    }
